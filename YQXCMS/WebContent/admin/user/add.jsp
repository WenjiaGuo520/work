...
<div id="head">
    ...
    <a href="javascript:void(0);" style="color: #AAA">用户增加</a>
</div>
...
<div id="info">
    ...
    <div id="form">
        <form class="form-horizontal" action="${pageContext.request.contextPath}/sys/user?cmd=add" method="post">
            <div class="form-group">
                <label for="username" class="col-sm-2 control-label">用户昵称: </label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username"/><span id="usernamechecked"></span>
                </div>
            </div>
            <div class="form-group">
                <label for="userpwd" class="col-sm-2 control-label">密码: </label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="userpwd" name="userpwd" /><span id="usernpwdchecked"></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="usertruename" name="usertruename" /><span id="usertruenamechecked"></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text"id="carid" class="form-control" name="carid" />
                </div>
            </div>
            <div class="form-group">

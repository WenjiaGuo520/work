	...
	<div class="row-fluid">
		...
		<!-- 文件上传的form表单的提交方式必须是post提交方式 -->
			<form class="form-horizontal"
				action="${pageContext.request.contextPath}/art/news?cmd=edit"
				method="post" enctype="multipart/form-data">
				<div class="control-group form-div">
					<label class="control-label" for="gtname">标题</label>
					<div class="controls">
						<input id="newstitle" class="form-control" type="text" name="arttitle" value="${condition.arttitle}" />
					</div>
				</div>
				...
				<div class="control-group form-div">
					...
					<div class="controls">
						<select name="tid" class="form-control">
							...
							<c:choose>
									<c:when test="${item.tid==condition.tid}">
				...
				<div class="control-group form-div">
					...
					<div class="controls">
						<input id="artabs" class="form-control" type="text" name="artabs" value="${condition.artabs}" />
					</div>
				</div>
				<!-- 演示图片上传功能 -->
				<div class="control-group form-div">
					<label class="control-label" for="artimg">当前图片</label>
					<div class="controls">
						<input type="text" id="artimg" class="form-control" value="${condition.artimg}" readonly="readonly" name="artimg"/>
					</div>
				</div>
				<!-- 演示图片上传功能 -->
				<div class="control-group form-div">
					<label class="control-label" for="newimgurl">重新上传图片?</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="5"  cols="40" class="ckeditor form-area" name="arttext" id="arttext">${condition.arttext}</textarea>
					</div>
				</div>
				<div class="control-group form-div">
					...
					<div class="controls">
						<input id="pubDate" class="form-control" type="date" name="pubDate"
						 value="<fmt:formatDate value='${condition.pubDate }' pattern='yyyy-MM-dd' />"/>
					</div>
				</div>
				<div class="control-group form-div">
					<label class="control-label" for="author">作者</label>
					<div class="controls">
						<input id="author" class="form-control" type="text" name="author" value="${condition.author }" />
					</div>
				</div>
				<div class="control-group form-div">
					<label class="control-label" for="artsource">来源</label>
					<div class="controls">
						<input id="artsource" class="form-control" type="text" name="artsource" value="${condition.artsource }" />
					</div>
				</div>
				
						<input type="text" hidden="true" name="aid" value="${condition.aid}">
				<div class="control-group form-div">
					<div class="controls" style="margin: 15px 0 50px 0;">

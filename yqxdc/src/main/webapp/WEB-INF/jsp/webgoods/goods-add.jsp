...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/web/goods/add"
				...
				<div class="panel panel-default">
					...
					<div style="width: 50%;margin: auto;">
						<div class="row data-type">
							...
							<div class="col-md-4 title">商品名称</div>
							<div class="col-md-8 data">
								<input type="text" class="form-control" name="gname"
									   placeholder="角色名称">
							</div>

							<div class="col-md-4 title">商品类型</div>
							<div class="col-md-8 data">

								<select class="form-control select2" style="width: 100%"
										name="gtid">
									<option value="123" selected="selected">类型1</option>
									<option value="456">类型2</option>
								</select>
							</div>

		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li class="system-setting"><a
							href="${pageContext.request.contextPath}/sys/user/toResetPwd"> <i
							class="fa fa-circle-o"></i> 重置密码
					</a></li>
					</security:authorize>
					...
					<li class="system-setting"><a
						href="${pageContext.request.contextPath}/sys/log/list"> <i
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li class="system-setting"><a
						href="${pageContext.request.contextPath}/web/goods/toAdd">
